 ...
 * docs: http://alloyframework.org/manual/url-router/
 */
class Components_Router
{
	...
	{
		$route                  = new Components_Router_Route( $route );
	 ...
	 */
	protected function routeMatch( Components_Router_Route $route, $method, $url )
	{
		$params = array();
	 ...
	 * @throws Exception For non-existent route name or params that don't match given route name (Unable to create URL string)
	 */
